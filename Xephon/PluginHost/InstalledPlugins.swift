...
///
/// Debug builds additionally carry `DebugSamplePlugin` so the
/// Phase 1 exit criteria (a plugin page rendering live session
/// data, an export through the root picker, a menu item) stay
/// verifiable on device. The Run action builds Release (see
